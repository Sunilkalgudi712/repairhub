...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if (empty($errors)) {
            try {
                $sql = "INSERT INTO customers (name, email, phone, alt_phone, address, city, state, pincode, gst_number, notes, created_at)
                        VALUES (:name, :email, :phone, :alt_phone, :address, :city, :state, :pincode, :gst_number, :notes, NOW())";
                ...
                // logActivity if function exists, or generic manual logging
                if (function_exists('logActivity')) {
                    logActivity($pdo, $_SESSION['user_id'], "Added new customer: $name");
                }
...
<div class="main-content" id="mainContent">
  <div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Add Customer</h2>
        <a href="index.php" class="btn btn-outline-secondary"><i class="fas fa-arrow-left"></i> Back to Customers</a>
    </div>
            ...
            <form method="POST" action="">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="alt_phone" class="form-control" value="<?= htmlspecialchars($_POST['alt_phone'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="gst_number" class="form-control" value="<?= htmlspecialchars($_POST['gst_number'] ?? '') ?>">
                    </div>
                </div>
